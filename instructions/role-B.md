...
This role focuses on the power operation feature and fixing test issues.

## Starting Point

Your starter branch: `starter/role-B`
...
1. Checkout your starter branch (`starter/role-B`).
...
Look at the test output and find the failing assertion in `test_power`. Figure out what the correct expected value should be and fix it.
